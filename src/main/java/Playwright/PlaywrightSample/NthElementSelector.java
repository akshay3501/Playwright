...
public class NthElementSelector {
	...
	com.microsoft.playwright.Locator first_ele = page. locator("div.footer-links li a >> nth=0");
	String firstEle = first_ele.textContent();
	System.out.println(firstEle);

	com.microsoft.playwright.Locator last_ele = page.locator("div.footer-links li a >> nth =- 1");
